      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight">
            Trade Smarter with ForexPro
          </h1>
          <p className="text-lg text-white/80 max-w-xl">
            Advanced trading platform with real-time analytics, multiple currency pairs, and professional tools for both novice and experienced traders.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 pt-8">
            <div>
              ...
              <div className="text-white/60">Currency Pairs</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white">0.01</div>
              <div className="text-white/60">Min Spread</div>
            </div>
            <div>
